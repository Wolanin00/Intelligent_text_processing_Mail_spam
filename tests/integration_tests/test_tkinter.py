...
class TestSpamClassifierApp(unittest.TestCase):

    SPAM_MAIL = "Dear Homeowner,\n\n \n\nInterest Rates are at their lowest point in 40 years!\n\n\n\nWe help you " \
    ...
    def test_classification_spam(self):
        ...
        with patch.object(messagebox, 'showinfo') as mock_showinfo:
            ...
            mock_showinfo.assert_called_once_with("Classification result", "The email is spam!")
    ...
    def test_classification_not_spam(self):
        ...
        with patch.object(messagebox, 'showinfo') as mock_showinfo:
            ...
            mock_showinfo.assert_called_once_with("Classification result", "Email is not spam.")
    ...
    def test_classification_no_text(self):
        ...
        with patch.object(messagebox, 'showwarning') as mock_showwarning:
            ...
            mock_showwarning.assert_called_once_with("Classification result", "Please enter your email text.")
