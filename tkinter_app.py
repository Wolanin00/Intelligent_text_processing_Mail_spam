...
class SpamClassifierApp:
    def __init__(self, master):
        ...
        self.title_label = tk.Label(
            master, text="Spam classifier", font=("Helvetica", 16)
        )
        ...
        self.text_label = tk.Label(
            self.text_frame, text="Enter your email text:", font=("Helvetica", 12)
        )
        ...
        self.classify_button = tk.Button(
            self.button_frame, text="Classify", command=self.classify_email
        )
